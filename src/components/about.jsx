            ...
            <div className="col-md-12">
                ...
                <div className="col-md-12">
                    ...
                    <p>I code in Python for my apprenticeship project but I am totally new to React.js. Looking at the prerequisite technical tasks for the application to TechLadies Bootcamp, 
                        ...
                        On a Saturday night ( in fact it was just a week before the deadline ) after putting my girls to bed, I started to update the React template that I like more seriously with a thought of nothing to lose even if it didn't get through.
